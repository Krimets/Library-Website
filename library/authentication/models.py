...
class CustomUserManager(BaseUserManager):
    ...
    def create_user_guest(self, email, password, **extra_fields):
...
class CustomUser(AbstractBaseUser):
    ...
    middle_name = models.CharField(max_length=20, default='Test')
    email = models.CharField(max_length=100, unique=True, default='test')
